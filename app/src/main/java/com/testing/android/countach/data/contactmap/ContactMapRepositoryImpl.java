...
final public class ContactMapRepositoryImpl implements ContactMapRepository {
    ...
    private final OrganizationsSearchService organizationSearchService;
    ...
    ContactMapRepositoryImpl(ApiKey apiKey,
                             ...
                             OrganizationsSearchService organizationSearchService,
    ...
    private List<Organization> searchForOrganizations(@Nullable String addressName) {
